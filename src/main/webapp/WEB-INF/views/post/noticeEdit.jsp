        ...
        <form action="http://localhost:8080/post/update?postId=${post.postId}" method="post">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th><input class="form-control" type="text" name="title" value="${post.title}" style="width: 100%"></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="notice-width">내용</td>
                    <td><textarea class="form-control" name="contents" style="width: 100%; height: 400px">${post.content}</textarea>
                    </td>
                </tr>
                </tbody>
            </table>
